    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            List<int> numberList = new List<int>(50);
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
            ...
            {
                Console.WriteLine($"this is your {searchNumber}");
            }
            else
            {
                Console.WriteLine($"we do not have your {searchNumber}");
            }
